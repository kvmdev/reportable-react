...
export default function RegistrarContador() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const createResponse = await api.post('/v0/api/admin/create/contadores', {
        ruc
      });


      if (createResponse.status === 200) {
        showNotification('¡Contador creado correctamente!', 'success');
